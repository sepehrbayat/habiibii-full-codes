...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::get('/delete-account-policy', 'HomeController@delete_account_policy');
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::group(['prefix' => 'rider','middleware' => 'actch:deliveryman_app'], function () {
        ...
        Route::group(['prefix' => 'seller','middleware' => 'actch:vendor_app'], function () {
    ...
    //Store Subscription
    Route::group(['prefix' => 'seller','namespace' => 'Vendor'], function () {
    ...
    Route::group(['prefix' => 'seller', 'namespace' => 'Vendor', 'middleware'=>['vendor.api','actch:vendor_app']], function () {
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('get-analytic-scripts', 'ConfigController@getAnalyticScripts');
    });
...
WebSocketsRouter::webSocket('/rider/live-location', DMLocationSocketHandler::class);
