    ...
    Route::group(['middleware' => ['admin', 'current-module', 'actch:admin_panel' ]], function () {
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            ...
            Route::group(['middleware' => ['module:store']], function () {
                ...
                Route::post('module-access/{store}', 'VendorController@updateModuleAccess')->name('module-access');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings']], function () {
            ...
            Route::get('pages/business-page/delete-account', 'BusinessSettingsController@delete_account_policy')->name('delete-account-policy');
            Route::post('pages/business-page/delete-account', 'BusinessSettingsController@delete_account_update');
            Route::get('pages/delete-account-policy/{status}', 'BusinessSettingsController@delete_account_policy_status')->name('delete-account-policy-status');
