                            ...
                            <div class="row g-2">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        data-url="{{url('/')}}/seller-panel/item/get-categories?parent_id=" data-id="sub-categories"
                                               >
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="sub_category_id" id="sub-categories"
                                                ...
                                                data-url="{{url('/')}}/seller-panel/item/get-categories?parent_id=" data-id="sub-sub-categories">
    ...
    function add_new_row_button(data) {
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('{{url('/')}}/seller-panel/item/get-categories?parent_id=' + category + '&&sub_category=' + sub_category, 'sub-categories');
                getRequest('{{url('/')}}/seller-panel/item/get-categories?parent_id=' + sub_category + '&&sub_category=' + sub_sub_category, 'sub-sub-categories');
            }, 1000)
        });
