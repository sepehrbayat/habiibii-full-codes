...
<head>
    ...
    <title>{{ translate('Booking_Confirmation') }}</title>
    <style>
...
<body style="background-color: #e9ecef;padding:15px">
    <table dir="{{ $site_direction }}" class="main-table">
        <tbody>
            <tr>
                <td>
                    <h2>{{ translate('Booking_Confirmation') }}</h2>
                    <div class="mb-2">
                        {{ translate('Dear') }} {{ $user_name }},
                    </div>
                    <div class="mb-2">
                        {{ translate('Your_booking_has_been_confirmed') }}.
                    </div>
                    <div class="booking-details">
                        ...
                        <p><strong>{{ translate('Total_Amount') }}:</strong> {{ number_format($booking->total_amount, 2) }}</p>
                    </div>
                    <div class="mb-2">
                        {{ translate('We_look_forward_to_serving_you') }}.
                    </div>
                    <hr>
                    <div class="mb-2">
