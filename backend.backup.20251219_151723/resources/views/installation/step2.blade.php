...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Habiibii Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Habiibii Software Installation"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">Provide your <strong>username of Habiibii</strong> & the purchase code </p>
                                ...
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-html="true"
                                              data-bs-title="The username of your Habiibii account">
                                                    <img
