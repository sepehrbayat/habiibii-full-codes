            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel/orders/*')  ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/parcel/orders/*') || Request::is('backoffice/order/offline/payment/list*')? 'block' : 'none' }}">
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/all') ? 'active' : '' }}">
                            ...
                            {{-- <li class="nav-item {{ Request::is('backoffice/parcel/orders/scheduled') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/pending') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/accepted') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/processing') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/item_on_the_way') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/delivered') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/canceled') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/orders/failed') ? 'active' : '' }}">
                            ...
                            {{-- <li class="nav-item {{ Request::is('backoffice/parcel/orders/refunded') ? 'active' : '' }}">
                    ...
                    <!-- Order dispachment -->
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel/dispatch/*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="{{ Request::is('backoffice/parcel*') ? 'display-block' : 'display-none' }}">
                            <li class="nav-item {{ Request::is('backoffice/parcel/dispatch/searching_for_deliverymen') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/parcel/dispatch/on_going') ? 'active' : '' }}">
