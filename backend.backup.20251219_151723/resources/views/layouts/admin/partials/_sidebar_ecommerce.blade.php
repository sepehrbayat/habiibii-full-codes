        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/flash-sale*') ? 'active' : '' }}">
            ...
            <!-- End advertisement -->
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/brand*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu  @yield('low_stock_list') {{ Request::is('backoffice/item*')  ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/item*') ||  Request::is('backoffice/report/stock-report*') ? 'block' : 'none' }}">
