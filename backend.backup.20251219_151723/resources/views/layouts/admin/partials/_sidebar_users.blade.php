        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    <!-- Dashboards -->
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users') ? 'show active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/cashback*') ? 'active' : '' }}">
                ...
                <li
                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/rider/vehicle*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/rider/add') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/rider/new') || Request::is('backoffice/users/rider/deny')  ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/rider') ||  Request::is('backoffice/users/rider/edit*') ||  Request::is('backoffice/users/rider/preview*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/rider/reviews') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('backoffice/users/customer/list') || Request::is('backoffice/users/customer/view*')) ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/customer/wallet*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/users/customer/wallet*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/users/customer/wallet/add-fund') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/users/customer/wallet/report*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/users/customer/wallet/bonus*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/customer/loyalty-point*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/users/customer/loyalty-point*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/users/customer/loyalty-point/report*') ? 'active' : '' }}">
                ...
                <!-- End Custommer -->
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/customer/subscribed') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/contact/contact-list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/custom-role*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/users/employee*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/users/employee*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/users/employee/store') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/users/employee/') ? 'active' : '' }}">
