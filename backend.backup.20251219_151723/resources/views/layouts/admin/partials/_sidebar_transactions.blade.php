            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('withdraw_list'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/store/withdraw*') ? 'active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('disbursement'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/store-disbursement*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('disbursement'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/dm-disbursement*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('collect_cash'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/account-transaction*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('provide_dm_earning'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/provide-deliveryman-earnings*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/withdraw-method*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('report'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/day-wise-report') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/item-wise-report') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/store*') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/expense-report') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/disbursement-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/report/order-report') ? 'active' : '' }}">
                ...
                @endif
                    @if (addon_published_status('Rental'))
                        ...
                        @if (\App\CentralLogics\Helpers::module_permission_check('rental_report'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/rental/report/transaction-report') ? 'active' : '' }}">
                                <a class="nav-link "
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/rental/report/vehicle-report') ? 'active' : '' }}">
                                <a class="nav-link "
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{!Request::is('backoffice/transactions/rental/report/provider-wise-taxes*') && Request::is('backoffice/transactions/rental/report/provider-wise*') ? 'active' : '' }}">
                                <a class="nav-link "
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/transactions/rental/report/trip-report') ? 'active' : '' }}">
                                <a class="nav-link "
