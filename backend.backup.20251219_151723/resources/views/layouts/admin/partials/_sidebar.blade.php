        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    <!-- Dashboards -->
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice') ? 'show active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('backoffice/pos*')?'active':''}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/zone*') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/module') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/module*') ? 'block' : 'none' }}">
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/module/create') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/campaign') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/campaign*') ? 'block' : 'none' }}">

                        <li class="nav-item {{ Request::is('backoffice/campaign/basic/*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/campaign/item/*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/banner*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/coupon*') ? 'active' : '' }}">
                ...
                <!-- End Coupon -->
                 ...
                 <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/cashback*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/notification*') ? 'active' : '' }}">
                ...
                <!-- End marketing section -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/order') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/order*') ? 'block' : 'none' }}">
                            <li class="nav-item {{ Request::is('backoffice/order/list/all') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/scheduled') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/pending') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/accepted') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/processing') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/item_on_the_way') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/delivered') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/canceled') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/failed') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/list/refunded') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/order/offline/payment/list*') ? 'active' : '' }}">
                    ...
                    <!-- Order refund -->
                    <li
                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/refund/*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        style="display: {{ Request::is('backoffice/refund*') ? 'block' : 'none' }}">

                        <li class="nav-item {{ Request::is('backoffice/refund/requested') ||  Request::is('backoffice/refund/rejected') ||Request::is('backoffice/refund/refunded') ? 'active' : '' }}">
                            <a class="nav-link "
                         ...
                         {{-- <li class="nav-item {{ Request::is('backoffice/refund/settings') ? 'active' : '' }}">
                    ...
                    <!-- Order dispachment -->
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/dispatch/*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="{{ Request::is('backoffice/dispatch*') ? 'display-block' : 'display-none' }}">
                            <li class="nav-item {{ Request::is('backoffice/dispatch/list/searching_for_deliverymen') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/dispatch/list/on_going') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/parcel*') ? 'block' : 'none' }}">
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel/category') ? 'active' : '' }}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel/orders*') ? 'active' : '' }}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/parcel/settings') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/category*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/category*') ? 'block' : 'none' }}">
                            <li class="nav-item @yield('main_category') {{ Request::is('backoffice/category/add') ? 'active' : '' }}">
                            ...
                            <li class="nav-item @yield('sub_category') {{ Request::is('backoffice/category/add-sub-category') ? 'active' : '' }}">
                            ...
                            {{-- <li class="nav-item {{Request::is('backoffice/category/add-sub-sub-category')?'active':''}}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/category/bulk-import') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/category/bulk-export') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/attribute*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/unit*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/addon*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/addon*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/addon/add-new') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/addon/bulk-import') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.addon.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('backoffice/addon/bulk-export') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/item*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/item*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/item/add-new') || (Request::is('backoffice/item/edit/*') && strpos(request()->fullUrl(), 'product_gellary=1') !== false  )  ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/item/list') || (Request::is('backoffice/item/edit/*') && (strpos(request()->fullUrl(), 'temp_product=1') == false && strpos(request()->fullUrl(), 'product_gellary=1') == false  ) ) ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{  Request::is('backoffice/item/product-gallery') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/item/new/item/list') || (Request::is('backoffice/item/edit/*') && strpos(request()->fullUrl(), 'temp_product=1') !== false  ) ? 'active' : '' }}">
                        ...
                        @endif
                        <li class="nav-item {{ Request::is('backoffice/item/reviews') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/item/bulk-import') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.item.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('backoffice/item/bulk-export') ? 'active' : '' }}">
                ...
                <!-- End Food -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store*') && !Request::is('backoffice/store/withdraw_list') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/store*') ? 'block' : 'none' }}">
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/add') ? 'active' : '' }}">
                            ...
                            <li class="navbar-item {{ Request::is('backoffice/store/list') ||  Request::is('backoffice/store/view/*')  ? 'active' : '' }}">
                            ...
                            <li class="navbar-item {{ Request::is('backoffice/store/pending-requests') ? 'active' : '' }}">
                            ...
                            <li class="navbar-item {{ Request::is('backoffice/store/recommended-store') ? 'active' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('backoffice/store/bulk-import') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.store.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('backoffice/store/bulk-export') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rider/add') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rider/new') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rider/list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rider/reviews/list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('backoffice/customer/list') || Request::is('backoffice/customer/view*')) ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/customer/wallet*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/customer/wallet*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/customer/wallet/add-fund') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/customer/wallet/report*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/customer/loyalty-point*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/customer/loyalty-point*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/customer/loyalty-point/report*') ? 'active' : '' }}">
                ...
                <!-- End Custommer -->
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/customer/subscribed') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/contact/contact-list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/customer/settings') ? 'active' : '' }}">
                ...
                <li
                class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/message/list') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/withdraw*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/account-transaction*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/provide-deliveryman-earnings*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/business-setup') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('backoffice/business-settings/social-media')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/payment-method') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/mail-config') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/sms-module') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/fcm-index') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/app-settings*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/landing-page-settings*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/config*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/business-settings/pages*') ? 'block' : 'none' }}">

                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/terms-and-conditions') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/privacy-policy') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/about-us') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/refund') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/delete-account') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.business-settings.delete-account') }}" title="{{ translate('messages.Delete Account Policy') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('Delete Account Policy') }}</span>
                            </a>
                        </li> 

                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/cancelation') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ Request::is('backoffice/business-settings/pages/shipping-policy') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/file-manager*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('backoffice/social-login/view')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/recaptcha*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{Request::is('backoffice/business-settings/db-index')?'active':''}}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/item-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/stock-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/store-wise-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/order-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/transaction-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/report/expense-report') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/custom-role*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/employee*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/employee*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/employee/add-new') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.employee.add-new') }}" title="{{ translate('messages.add_new_Employee') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.add_new') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('backoffice/employee/list') ? 'active' : '' }}">
