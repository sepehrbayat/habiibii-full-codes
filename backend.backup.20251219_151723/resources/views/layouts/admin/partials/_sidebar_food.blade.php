    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/promotional-banner*') ? 'active' : '' }}">
            ...
            @if (\App\CentralLogics\Helpers::module_permission_check('advertisement'))
                <li
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        style="display: {{ Request::is('backoffice/advertisement*') ? 'block' : 'none' }}">
            ...
            <!-- End advertisement -->
                <!-- End marketing section -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/category*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('backoffice/category*') ? 'block' : 'none' }}">
                                <li class="nav-item  @yield('main_category') {{ request()->input('position') == 0 && Request::is('backoffice/category/add') ? 'active' : '' }}">
                                ...
                                <li class="nav-item   @yield('sub_category') {{ request()->input('position') == 1 && Request::is('backoffice/category/add') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/addon*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/addon*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('backoffice/addon/addon-category') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/item*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/item*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{  Request::is('backoffice/item/requested/item/view/*') || Request::is('backoffice/item/new/item/list') || (Request::is('backoffice/item/edit/*') && strpos(request()->fullUrl(), 'temp_product=1') !== false  ) ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/pending-requests') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/list') ||  Request::is('backoffice/store/view/*') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/bulk-import') ? 'active' : '' }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/store/bulk-export') ? 'active' : '' }}">
