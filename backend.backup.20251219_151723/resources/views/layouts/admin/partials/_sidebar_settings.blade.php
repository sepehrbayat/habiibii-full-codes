            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('zone'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/zone*') ? 'active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('module'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/module') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('backoffice/business-settings/module*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/module/store') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/business-setup*') || Request::is('backoffice/business-settings/language*') ? 'active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('subscription'))
                        <li class="navbar-vertical-aside-has-menu @yield('subscription')">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('backoffice/business-settings/subscription*') ? 'block' : 'none' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('backoffice/business-settings/pages*') ? 'block' : 'none' }}">

                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages/social-media') ? 'active' : '' }}">
                                    <a class="nav-link "
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages/admin-landing-page-settings*') ? 'active' : '' }}">
                                    <a class="nav-link "
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages/react-landing-page-settings*') ? 'active' : '' }}">
                                    <a class="nav-link "
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages/flutter-landing-page-settings*') ? 'active' : '' }}">
                                    <a class="nav-link "
                                ...
                                <li class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/delete-account') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.business-settings.delete-account-policy') }}"
                                        title="{{ translate('messages.Delete Account Policy') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/pages/business-page*') ? 'active' : '' }}">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display:{{ Request::is('backoffice/business-settings/pages/business-page*') ? 'block' : 'none' }}">
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/terms-and-conditions') ? 'active' : '' }}">
                                            <a class="nav-link "
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/privacy-policy') ? 'active' : '' }}">
                                            <a class="nav-link "
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/about-us') ? 'active' : '' }}">
                                            <a class="nav-link "
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/refund') ? 'active' : '' }}">
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/cancelation') ? 'active' : '' }}">
                                            <a class="nav-link "
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('backoffice/business-settings/pages/business-page/shipping-policy') ? 'active' : '' }}">
                                            <a class="nav-link "
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/file-manager*') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/third-party*') || Request::is('backoffice/business-settings/fcm*') || Request::is('backoffice/business-settings/offline-payment*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('backoffice/business-settings/third-party*') || Request::is('backoffice/business-settings/fcm*') || Request::is('backoffice/business-settings/login-url-setup*') || Request::is('backoffice/business-settings/offline-payment*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/third-party*') ? 'active' : '' }}">
                                    <a class="nav-link "
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/fcm*') ? 'active' : '' }}">
                                ...
                                {{--                                <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/login-url-setup*') ? 'active' : '' }}"> --}}
                                ...
                                {{-- <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/login_page*') ? 'active' : '' }}">
                                ...
                                @if (\App\CentralLogics\Helpers::get_mail_status('offline_payment_status'))
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/offline*') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/login-settings*') || Request::is('backoffice/business-settings/login-url-setup*') ? 'active' : '' }}">
                        ...
                        {{-- <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/react*') ? 'active' : '' }}">
                        ...
                        @if (addon_published_status('Rental'))
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/rental-email-setup*') || Request::is('backoffice/business-settings/email-setup*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" id="tourb-3"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display:{{ Request::is('backoffice/business-settings/rental-email-setup*') || Request::is('backoffice/business-settings/email-setup*') ? 'block' : 'none' }}">

                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/email-setup*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu  {{ Request::is('backoffice/business-settings/rental-email-setup*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/app-settings*') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/addon-activation*') ? 'active' : '' }}">
                            <a class="nav-link "
                        ...
                        @if (addon_published_status('Rental'))
                            <li class="navbar-vertical-aside-has-menu @yield('notification_setup_type')">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display:{{ Request::is('backoffice/business-settings/notification-setup*') ? 'block' : 'none' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/db-index') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <!-- Dashboards -->
                    <li
                        class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/business-settings/system-addon') ? 'show active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    @php
                        $addonAdminRoutes = config('addon_admin_routes', []);
                        $addonAdminRoutes = is_array($addonAdminRoutes) && !is_null($addonAdminRoutes) ? $addonAdminRoutes : [];
                    @endphp
                    @if (!empty($addonAdminRoutes) && count($addonAdminRoutes) > 0)
                        <li class="nav-item">
                            <small class="nav-subtitle">{{ translate('messages.addon_menus') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/payment/configuration/*') || Request::is('backoffice/sms/configuration/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('backoffice/payment/configuration/*') || Request::is('backoffice/sms/configuration/*') ? 'block' : 'none' }}">
                                @foreach ($addonAdminRoutes as $routes)
