                ...
                <div class="navbar-bottom-wrapper">
                    ...
                    <div class="dropdown--btn-hover position-relative">
                        ...
                        <ul class="dropdown-list">
                            <li>
                                <a class="" href="/login/seller">
                                    {{ translate('messages.Seller Login') }}
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="" {{--href="{{ route('restaurant.create') }}"--}} href="https://habiibii.com/store-registration?active=active">
                        ...
                        @if ($toggle_dm_registration)
                            <li><a class=""
                                    {{-- href="{{ route('deliveryman.create') }}" --}} href="https://habiibii.com/rider-registration">{{ translate('messages.deliveryman_registration') }}</a>
                            </li>
                        @endif
                        </ul>
                    </div>
