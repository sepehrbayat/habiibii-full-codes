                ...
                <form action="{{ route('admin.business-settings.order-cancel-reasons.store') }}" method="post">
                    @csrf
                        ...
                        <div class="row g-3">
                            ...
                            @if ($language)
                                @foreach (json_decode($language) as $lang)
                                    <div class="col-sm-6 {{$lang == 'en' ? '' : 'd-none'}} lang_form1" id="{{ $lang }}-form1">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <ul class="nav nav-tabs nav--tabs mb-3 border-0">
                                                                        ...
                                                                        <div class="form-group mb-3 add_active_2  update-lang_form" id="default-form_{{$reason->id}}">
                                                                            <label for="reason" class="form-label">{{translate('Order Cancellation Reason')}} (EN) </label>
                                                                            ...
                                                                            <input type="hidden" name="lang1[]" value="default">
                                                                                        ...
                                                                                        @if($language)
                                                                                            ...
                                                                                            <?php
                                                                                                ...
                                                                                                ?>
                                                                                                <div class="form-group mb-3 {{$lang == 'en' ? '' : 'd-none'}} update-lang_form" id="{{$lang}}-langform_{{$reason->id}}">
