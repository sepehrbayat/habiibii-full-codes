                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="lang[]" value="default"> --}}
                                    ...
                                    if(isset($fixed_header_sub_title->translations)&&count($fixed_header_sub_title->translations)){
                                        ...
                                        ?>
                                    <div class="col-md-12 {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form1">
                                        <div class="row g-3">
                                            <div class="col-12">
                        ...
                        @if ($language)
                            ...
                            <input type="hidden" name="lang[]" value="default"> --}}
                                ...
                                if(isset($fixed_location_title->translations)&&count($fixed_location_title->translations)){
                                    ...
                                    ?>
                                    <div class="row g-3 {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form2">
                                        <div class="col-sm-12">
                        ...
                        @if ($language)
                            ...
                            <input type="hidden" name="lang[]" value="default"> --}}
                                ...
                                if(isset($fixed_module_sub_title->translations)&&count($fixed_module_sub_title->translations)){
                                    ...
                                    ?>
                                    <div class="row g-3 {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form">
                                        <div class="col-sm-6">
