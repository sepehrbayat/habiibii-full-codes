                                    ...
                                    <div>
                                        ...
                                        @if ($language)
                                            ...
                                            if($data && count($data['translations'])){
                                                ...
                                                ?>
                                                <div class="__bg-F8F9FC-card {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form">
                                                    <div class="form-group">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        ?>
                                                        <div class="form-group m-0 {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form1">
                                                            <label class="form-label text-capitalize">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                                @if ($language)
                                                    ...
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        ?>
                                                        <div class="form-group {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form2">
                                                            <label class="form-label">
                                            ...
                                            <div class="form-group mb-0">
                                                @if ($language)
                                                        {{-- <div class="form-group lang_form default-form">
                                                            ...
                                                            <input type="text" data-id="mail-copyright" name="copyright_text[]"  placeholder="{{ translate('Ex:_Copyright_2023_Habiibii._All_right_reserved') }}" class="form-control" value="{{ $data?->getRawOriginal('copyright_text') }}">
                                                        </div> --}}
                                                    @foreach(json_decode($language) as $lang)
                                                    <?php
                                           $translate = [];
                                           if($data && count($data['translations'])){
                                                        ...
                                                        ?>
                                                        <div class="form-group {{$lang == 'en' ? '' : 'd-none'}} lang_form" id="{{$lang}}-form3">
                                                            <label class="form-label">
                                                                {{translate('Copyright Content')}}({{strtoupper($lang)}})
                                                            </label>
                                                            <input type="text" name="copyright_text[]"  placeholder="{{ translate('Ex:_Copyright_2023_Habiibii._All_right_reserved') }}" class="form-control" value="{{ $translate[$lang]['copyright_text']??'' }}">
                                                        </div>
                                                    @endforeach
                                                @else
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="{{ translate('Ex:_Copyright_2023_Habiibii._All_right_reserved') }}" class="form-control" name="copyright_text[]" value="">
                                                </div>
                                                @endif
                                            </div>
                                        </div>
