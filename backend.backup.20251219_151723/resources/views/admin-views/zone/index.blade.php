                        ...
                        <div class="col-md-6">
                            <div class="bg-light rounded p-20">
                                ...
                                <div class="tab-content">
                                    ...
                                    @foreach($language as $lang)
                                        <div class="row g-3 lang_form {{$lang == 'en' ? '' : 'd-none'}}" id="{{$lang}}-form">
                                            <div class="form-group col-12 mb-0">
            ...
            $.post({
                ...
                success: function (data) {
                    if(data.errors){
                        ...
                        $("#module-setup-modal-button").prop("href",'{{url('/')}}/backoffice/business-settings/zone/module-setup/'+ data.id)
                        $("#module-setup-modal-button-2").prop("href",'{{url('/')}}/backoffice/business-settings/zone/module-setup/'+ data.id)
