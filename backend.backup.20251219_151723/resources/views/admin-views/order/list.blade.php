...
@section('content')
    <div class="content container-fluid">
        @php($parcel_order = Request::is('backoffice/parcel/orders*'))
        <!-- Page Header -->
                ...
                <div class="col-xl-10 col-md-9 col-sm-8 mb-3 mb-sm-0 {{$parcel_order ? 'mb-2':''}}">
                    <h1 class="page-header-title text-capitalize m-0">
                        ...
                        <span>
                            ...
                            @elseif(Request::is('backoffice/refund/*') ) {{translate('messages.Refund')}}  {{translate(str_replace('_',' ',$status))}}
        ...
        <div class="card">
            ...
            <div class="card-header py-1 border-0">
                <div class="search--button-wrapper justify-content-end">
                    ...
                    @if(Request::is('backoffice/refund/*'))
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#reset').on('click', function(){
                    location.href = '{{url('/')}}/backoffice/order/filter/reset';
                });
            });
        </script>
        <script>
