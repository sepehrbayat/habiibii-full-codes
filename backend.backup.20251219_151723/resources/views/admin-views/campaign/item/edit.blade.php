...
@push('script_2')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            getStoreData('{{url('/')}}/backoffice/store/get-addons?store_id={{$campaign['store_id']}}@foreach(json_decode($campaign['add_ons'], true) as $addon)&data[]={{$addon}}@endforeach','add_on');
            @else
            getStoreData('{{url('/')}}/backoffice/store/get-addons?data[]=0&store_id={{$campaign['store_id']}}','add_on');
            @endif
        });
        ...
        $('#store_id').select2({
            ajax: {
                url: '{{url('/')}}/backoffice/store/get-stores',
        ...
        $('#category_id').select2({
            ajax: {
                url: '{{url('/')}}/backoffice/item/get-categories?parent_id=0',
                data: function (params) {
                    return {
                        q: params.term, // search term
                        page: params.page,
        ...
        $('#sub-categories').select2({
            ajax: {
                url: '{{url('/')}}/backoffice/item/get-categories',
                data: function (params) {
                    return {
                        q: params.term, // search term
                        page: params.page,
