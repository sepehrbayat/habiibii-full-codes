...
@push('script_2')
    ...
    <script>
        ...
        $('#store_id').on('change', function () {
            let route = '{{url('/')}}/backoffice/store/get-addons?data[]=0&store_id='+$(this).val();
            let id = 'add_on';
        ...
        $('#sub-categories').on('change', function () {
            let route = '{{url('/')}}/backoffice/item/get-categories?parent_id='+$(this).val();
        ...
        {
            $.get({
                url: "{{url('/')}}/backoffice/business-settings/module/show/"+id,
                dataType: 'json',
                success: function (data) {
                    module_data = data;
