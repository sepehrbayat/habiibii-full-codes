...
@push('script_2')
    ...
    <script>
        ...
        function get_items()
        {
            var nurl = '{{url('/')}}/backoffice/item/get-items?module_id='+module_id;
        ...
        getRequest('{{url('/')}}/backoffice/item/get-items?module_id={{$banner->module_id}}&zone_id={{$banner->zone_id}}&data[]={{$banner->data}}','choice_item');
        @endif
