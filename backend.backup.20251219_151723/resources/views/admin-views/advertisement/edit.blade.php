...
@section('title',Request::is('backoffice/advertisement/copy-advertisement/*') ? translate('New_Advertisement')  : translate('Advertisement_Edit'))
...
<div class="content container-fluid">
    ...
    <h1 class="page-header-title mb-3">
        {{ Request::is('backoffice/advertisement/copy-advertisement/*') ? translate('New_Advertisement')  : translate('Advertisement_Edit') }}
    </h1>
    ...
    <div class="card mb-20">
        <div class="card-body p-30">
            <form id="create-add-form"  method="post" enctype="multipart/form-data" >
                @csrf
                @if (Request::is('backoffice/advertisement/copy-advertisement/*'))
                @method("POST")
...
<script>
            $(document).on('ready', function() {
                    ...
                    $('#create-add-form').on('submit', function (event) {
                        ...
                        $.post({
                            url: `{{ Request::is('backoffice/advertisement/copy-advertisement/*') ? route('admin.advertisement.copyAddPost',$advertisement?->id) : route('admin.advertisement.update',$advertisement?->id) }}`,
