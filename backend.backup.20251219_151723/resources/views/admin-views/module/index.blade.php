            ...
            <div class="card-body p-0">
                <div class="table-responsive datatable-custom">
                    <table id="columnSearchDatatable"
                        ...
                        @php
                            // Check if module should be displayed based on addon published status
                            // بررسی اینکه آیا ماژول باید نمایش داده شود بر اساس وضعیت انتشار افزونه
                            $shouldShow = true;
                            
                            // Hide rental module if Rental addon is not published
                            // مخفی کردن ماژول rental اگر افزونه Rental منتشر نشده باشد
                            if ($module->module_type == 'rental' && addon_published_status('Rental') != 1) {
                                $shouldShow = false;
                            }
                            
                            // Show beauty module only if BeautyBooking addon is published
                            // نمایش ماژول beauty فقط اگر افزونه BeautyBooking منتشر شده باشد
