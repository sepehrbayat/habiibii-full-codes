                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <select id="deliveryman" name="deliveryman_id" data-placeholder="{{translate('messages.select_deliveryman')}}" data-url="{{url('/')}}/backoffice/users/rider/get-account-data/" data-type="deliveryman" class="form-control account-data" title="Select deliveryman">
...
<script>
    ...
    $('#deliveryman').select2({
        ajax: {
            url: '{{url('/')}}/backoffice/users/rider/get-deliverymen',
