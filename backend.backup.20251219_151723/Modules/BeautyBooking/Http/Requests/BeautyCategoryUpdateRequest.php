...
/**
 * Beauty Category Update Request
 * درخواست به‌روزرسانی دسته‌بندی
 */
class BeautyCategoryUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'parent_id' => 'nullable|integer|exists:beauty_service_categories,id|not_in:' . $id,
    ...
    public function messages(): array
    {
        return [
            ...
            'parent_id.not_in' => translate('messages.cannot_be_parent_of_itself'),
