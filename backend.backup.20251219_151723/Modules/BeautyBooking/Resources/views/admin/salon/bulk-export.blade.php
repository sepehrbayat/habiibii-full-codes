...
@section('title',translate('messages.salon_bulk_export'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.export_salons')}}
                </span>
            </h1>
        </div>
...
@push('script_2')
<script src="{{asset('Modules/BeautyBooking/public/assets/js/admin/salon-bulk-export.js')}}"></script>
@endpush
