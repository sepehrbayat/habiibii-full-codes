...
@section('title',translate('Salon Bulk Import'))
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset('public/assets/admin/img/rental/provider.png')}}" class="w--20" alt="">
                </span>
                <span>
                    {{translate('messages.Salons_bulk_import')}}
                </span>
            </h1>
        </div>
        <!-- Content Row -->
            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        ...
                        <a href="{{asset('public/assets/salons_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary">{{ translate('Template with Existing Data') }}</a>
                        <a href="{{asset('public/assets/salons_bulk_format_nodata.xlsx')}}" download="" class="btn btn--primary">{{ translate('Template without Data') }}</a>
        ...
        <div class="card mt-2 rest-part">
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <h5 class="text-capitalize mb-3">{{ translate('Import_Salons_file') }}</h5>
                        <label class="uploadDnD d-block">
                            <div class="form-group inputDnD input_image input_image_edit position-relative">
                                ...
                                <input type="file" name="salons_file" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area" id="salons_file">
                            </div>
                        </label>
...
@push('script_2')
<script src="{{asset('Modules/BeautyBooking/public/assets/js/admin/salon-bulk-import.js')}}"></script>
@endpush
