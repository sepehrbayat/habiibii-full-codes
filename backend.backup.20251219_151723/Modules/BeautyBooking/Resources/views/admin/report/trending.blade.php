...
@section('title', translate('Trending Clinics'))
...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                <div>
                    <h1 class="page-header-title text-break">
                        ...
                        <span>{{ translate('messages.Trending_Clinics') }}
                        </span>
                    </h1>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">{{ translate('Reporting Period') }}:
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('Clinic Name') }}</th>
                                <th class="border-0 text-right">{{ translate('Bookings (30 days)') }}</th>
                        ...
                        <tbody>
                            @forelse($salons as $index => $salon)
                                <tr>
                                    ...
                                    <td class="text-right"><span class="text--title">{{ $salon->bookings_count ?? 0 }}</span></td>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <div class="empty--data">
                                            ...
                                            <h5>{{ translate('No trending clinics found') }}</h5>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
