...
/**
 * Beauty Gift Card Export
 * خروجی کارت‌های هدیه زیبایی
 */
class BeautyGiftCardExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.gift-card-export', [
            'data' => $this->data,
        ]);
    }
