...
/**
 * Beauty Loyalty Export
 * خروجی کمپین‌های وفاداری زیبایی
 */
class BeautyLoyaltyExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.loyalty-export', [
            'data' => $this->data,
        ]);
    }
