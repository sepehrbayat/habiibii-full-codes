...
namespace Modules\BeautyBooking\Exports;
...
/**
 * Beauty Subscription Export
 * خروجی اشتراک‌های زیبایی
 */
class BeautySubscriptionExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.subscription-export', [
            'data' => $this->data,
        ]);
    }
