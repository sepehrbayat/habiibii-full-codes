...
/**
 * Beauty Staff Export
 * خروجی کارمندان زیبایی
 */
class BeautyStaffExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.staff-export', [
            'data' => $this->data,
        ]);
    }
