...
/**
 * Beauty Booking Export
 * خروجی رزروهای زیبایی
 */
class BeautyBookingExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.booking-export', [
            'data' => $this->data,
        ]);
    }
