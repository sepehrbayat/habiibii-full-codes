...
/**
 * Beauty Transaction Export
 * خروجی تراکنش‌های زیبایی
 */
class BeautyTransactionExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.transaction-export', [
            'data' => $this->data,
        ]);
    }
