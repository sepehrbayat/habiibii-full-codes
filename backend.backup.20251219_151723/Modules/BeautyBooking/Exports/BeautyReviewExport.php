...
/**
 * Beauty Review Export
 * خروجی نظرات زیبایی
 */
class BeautyReviewExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.review-export', [
            'data' => $this->data,
        ]);
    }
