...
/**
 * Beauty Retail Export
 * خروجی محصولات خرده‌فروشی زیبایی
 */
class BeautyRetailExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.retail-export', [
            'data' => $this->data,
        ]);
    }
