...
/**
 * Beauty Package Export
 * خروجی پکیج‌های زیبایی
 */
class BeautyPackageExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.package-export', [
            'data' => $this->data,
        ]);
    }
