...
/**
 * Beauty Category Export
 * خروجی دسته‌بندی‌های زیبایی
 */
class BeautyCategoryExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.category-export', [
            'data' => $this->data,
        ]);
    }
