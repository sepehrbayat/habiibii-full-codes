...
/**
 * Beauty Service Export
 * خروجی خدمات زیبایی
 */
class BeautyServiceExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.service-export', [
            'data' => $this->data,
        ]);
    }
