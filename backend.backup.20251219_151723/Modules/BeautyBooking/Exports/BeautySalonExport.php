...
/**
 * Beauty Salon Export
 * خروجی سالن‌های زیبایی
 */
class BeautySalonExport implements FromView, ShouldAutoSize, WithStyles, WithEvents
{
    use Exportable;
    ...
    {
        return view('beautybooking::file-exports.salon-export', [
            'data' => $this->data,
        ]);
    }
