            ...
            <div class="modal-body">
                <form action="javascript:" method="post" id="add-schedule" data-route="{{route('admin.store.add-schedule')}}">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="start_time" required value="00:00">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">{{translate('messages.End time')}}:</label>
                        <input type="time" class="form-control" name="end_time" required value="23:59">
                    </div> --}}
                    <div class="form-group">
                        <label for="start_time">{{ translate('messages.Start time') }}</label>
                        <input type="text" id="start_time" name="start_time" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="end_time">{{ translate('messages.End time') }}</label>
