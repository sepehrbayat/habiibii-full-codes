                ...
                <div class="modal-body">
                    <form method="POST" action="javascript:" method="post" id="add-schedule" data-route="{{route('vendor.business-settings.add-schedule')}}">
                        ...
                        {{-- <div class=" ">
                            ...
                            <input type="time"  id="recipient-name" class="form-control" name="start_time" required value="00:00">
                        </div>
                        <div class=" ">
                            <label for="message-text" class="col-form-label">{{translate('messages.End time')}}:</label>
                            <input type="time" id="message-text" class="form-control" name="end_time" required value="23:59">
                        </div> --}}
                        <div class="">
                            <label for="start_time" class="col-form-label">{{ translate('messages.Start time') }}:</label>
                            <input type="text" id="start_time" class="form-control" name="start_time" required>
                        </div>

                        <div class="">
                            <label for="end_time" class="col-form-label">{{ translate('messages.End time') }}:</label>
                            <input type="text" id="end_time" class="form-control" name="end_time" required>
                        </div>

                        {{-- اضافه کردن Flatpickr --}}
