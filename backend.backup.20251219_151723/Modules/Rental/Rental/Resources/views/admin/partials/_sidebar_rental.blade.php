        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    <!-- Dashboards -->
                    <li class="navbar-vertical-aside-has-menu @yield('dashboard') {{ Request::is('backoffice') ? 'show active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('trip'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/trip*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/rental/trip*') ? 'block' : 'none' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('promotion'))
                        ...
                        <!-- Banner -->
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/banner*') ? 'active' : '' }}">
                        ...
                        <!-- Coupon -->
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/coupon*') ? 'active' : '' }}">
                        ...
                        <!-- End Coupon -->
                         <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/cashback*') ? 'active' : '' }}">
                        ...
                        <!-- Notification -->
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/notification*') ? 'active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('vehicle'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/category/list') || Request::is('backoffice/rental/category/edit*') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/brand/list') || Request::is('backoffice/rental/brand/edit*') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/vehicle*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('backoffice/rental/provider/vehicle*') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('backoffice/rental/provider/vehicle/create') || Request::is('backoffice/rental/provider/vehicle/edit/*')  ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::is('backoffice/rental/provider/vehicle/list')  ||Request::is('backoffice/rental/provider/vehicle/update/*') ||Request::is('backoffice/rental/provider/vehicle/details/*') || Request::is('backoffice/rental/provider/vehicle/edit/*')  ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.rental.provider.vehicle.list') }}" title="{{ translate('messages.vehicle_list') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('messages.list') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('backoffice/rental/provider/vehicle/review-list') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::is('backoffice/rental/provider/vehicle/bulk-import') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::is('backoffice/rental/provider/vehicle/bulk-export') ? 'active' : '' }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('provider'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/new-requests') || Request::is('backoffice/rental/provider/new-requests-details/*') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/create') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/list') ||  Request::is('backoffice/rental/provider/details/*') ||  Request::is('backoffice/rental/provider/driver/*') ||  Request::is('backoffice/rental/provider/edit*') ||  Request::is('backoffice/store/withdraw-view*') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/bulk-import') ? 'active' : '' }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('backoffice/rental/provider/bulk-export') ? 'active' : '' }}">
                   ...
                   @endif
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('download_app'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('backoffice/rental/settings*')?'active':''}}">
