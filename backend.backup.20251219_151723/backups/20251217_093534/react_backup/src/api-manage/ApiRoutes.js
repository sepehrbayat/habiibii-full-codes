...
export const subscription_package = "/api/v1/seller/package-view";
export const store_registration = "api/v1/auth/seller/register";
export const store_business_plan = "/api/v1/seller/business_plan";
export const top_offer_near_me = "api/v1/stores/top-offer-near-me";
export const delivery_men_store = "api/v1/rider/store";
export const vehicle_list = "/api/v1/get-vehicles";
export const zone_list = "/api/v1/zone/list";
export const delivery_man_registaration = "api/v1/auth/rider/store";
...
// Beauty Booking API Routes
export const beauty_salons_search = "/api/v1/beautybooking/salons/search";
export const beauty_salon_details = "/api/v1/beautybooking/salons";
export const beauty_salons_popular = "/api/v1/beautybooking/salons/popular";
export const beauty_salons_top_rated = "/api/v1/beautybooking/salons/top-rated";
export const beauty_salons_monthly_top_rated = "/api/v1/beautybooking/salons/monthly-top-rated";
export const beauty_salons_trending_clinics = "/api/v1/beautybooking/salons/trending-clinics";
export const beauty_bookings = "/api/v1/beautybooking/bookings";
export const beauty_booking_availability = "/api/v1/beautybooking/availability/check";
export const beauty_packages = "/api/v1/beautybooking/packages";
export const beauty_gift_cards = "/api/v1/beautybooking/gift-card";
export const beauty_loyalty_points = "/api/v1/beautybooking/loyalty/points";
export const beauty_loyalty_campaigns = "/api/v1/beautybooking/loyalty/campaigns";
export const beauty_consultations = "/api/v1/beautybooking/consultations";
export const beauty_retail_products = "/api/v1/beautybooking/retail/products";
export const beauty_reviews = "/api/v1/beautybooking/reviews";
export const beauty_categories = "/api/v1/beautybooking/salons/category-list";
