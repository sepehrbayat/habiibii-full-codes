...
const BusinessPlan = ({ formSubmit, isLoading }) => {
  ...
  const totalCommission = Number(configData?.admin_commission) + 3;
  return (
    <CustomStackFullWidth
      sx={{
          ...
          {configData?.commission_business_model !== 0 && (
            ...
            >
              ...
              <Typography fontSize="13px" color={theme.palette.neutral[400]}>
                ...
                {t(
                  `Registration and adding your products and services on Habibi are completely free and without any limitations. After each completed order, a ${totalCommission}% commission (including a 3% banking network processing fee) will be deducted. You will have full access to all store panel features, the app, and user interaction tools.`
                )}
              </Typography>
            </Stack>
          )}
