...
class ModuleRepository implements ModuleRepositoryInterface
{
    ...
    {
        // Handle null searchValue to prevent deprecation warning in PHP 8.4
        // مدیریت searchValue null برای جلوگیری از هشدار deprecation در PHP 8.4
        $key = $searchValue ? explode(' ', $searchValue) : [];
