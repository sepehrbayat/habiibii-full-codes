...
// منتظر در دسترس بودن jQuery قبل از استفاده
(function() {
    function initSlideHandler() {
        if (typeof jQuery !== 'undefined' && typeof $ !== 'undefined') {
            ...
            setTimeout(initSlideHandler, 50);
        }
    }
    
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initSlideHandler);
    } else {
        initSlideHandler();
    }
})();
...
// انتظار برای در دسترس بودن jQuery قبل از استفاده از $
(function() {
    function initAddRequiredAttribute() {
        if (typeof jQuery !== 'undefined' && typeof $ !== 'undefined') {
            ...
            // تلاش مجدد اگر jQuery هنوز بارگذاری نشده باشد
            setTimeout(initAddRequiredAttribute, 50);
        }
    }
    
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initAddRequiredAttribute);
    } else {
        initAddRequiredAttribute();
    }
})();

// Wrap all jQuery-dependent code in availability check
// قرار دادن تمام کدهای وابسته به jQuery در بررسی در دسترس بودن
(function() {
    function initJQueryHandlers() {
        if (typeof jQuery !== 'undefined' && typeof $ !== 'undefined') {
            ...
            // Retry if jQuery is not loaded yet
            // تلاش مجدد اگر jQuery هنوز بارگذاری نشده باشد
            setTimeout(initJQueryHandlers, 50);
        }
    }
...
// Wait for jQuery before using $
// انتظار برای jQuery قبل از استفاده از $
(function() {
    function initUploadHandlers() {
        if (typeof jQuery !== 'undefined' && typeof $ !== 'undefined') {
            ...
            setTimeout(initUploadHandlers, 50);
        }
    }
...
// منتظر در دسترس بودن jQuery قبل از استفاده
(function() {
    function initRouteAndFilterHandlers() {
        if (typeof jQuery !== 'undefined' && typeof $ !== 'undefined') {
            ...
            // jQuery not loaded yet, wait for it
            setTimeout(initRouteAndFilterHandlers, 50);
        }
    }
    
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initRouteAndFilterHandlers);
    } else {
        initRouteAndFilterHandlers();
    }
})();
$(document).ready(function () {
