...
class _PickMapScreenState extends State<PickMapScreen> {
  ...
  Widget build(BuildContext context) {
    // Skip map in development mode
    if(AppConstants.enableDebugLogs) {
      if(kDebugMode) {
        debugPrint('Development mode: Skipping map picker');
        return Scaffold(
          ...
          body: SafeArea(child: Center(child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Map skipped in development mode', style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                const SizedBox(height: 16),
                CustomButton(
                  buttonText: 'Continue',
                  onPressed: () => _onPickAddressButtonPressed(Get.find<LocationController>()),
                ),
              ],
            ),
          ))),
