...
import 'package:sixam_mart/features/beauty_module/home/domain/repositories/beauty_home_repository.dart';
import 'package:sixam_mart/features/beauty_module/home/domain/repositories/beauty_home_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/home/domain/services/beauty_home_service.dart';
...
import 'package:sixam_mart/features/beauty_module/salon_details/domain/repositories/beauty_salon_repository.dart';
...
import 'package:sixam_mart/features/beauty_module/salon_details/domain/services/beauty_salon_service.dart';
...
import 'package:sixam_mart/features/beauty_module/booking/domain/repositories/beauty_booking_repository.dart';
import 'package:sixam_mart/features/beauty_module/booking/domain/repositories/beauty_booking_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/booking/domain/services/beauty_booking_service.dart';
...
import 'package:sixam_mart/features/beauty_module/retail/domain/repositories/beauty_retail_repository.dart';
import 'package:sixam_mart/features/beauty_module/retail/domain/repositories/beauty_retail_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/retail/domain/services/beauty_retail_service.dart';
import 'package:sixam_mart/features/beauty_module/retail/domain/services/beauty_retail_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/packages/controllers/beauty_package_controller.dart';
import 'package:sixam_mart/features/beauty_module/packages/domain/repositories/beauty_package_repository.dart';
import 'package:sixam_mart/features/beauty_module/packages/domain/repositories/beauty_package_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/packages/domain/services/beauty_package_service.dart';
import 'package:sixam_mart/features/beauty_module/packages/domain/services/beauty_package_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/controllers/beauty_gift_card_controller.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/domain/repositories/beauty_gift_card_repository.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/domain/repositories/beauty_gift_card_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/domain/services/beauty_gift_card_service.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/domain/services/beauty_gift_card_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/controllers/beauty_loyalty_controller.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/domain/repositories/beauty_loyalty_repository.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/domain/repositories/beauty_loyalty_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/domain/services/beauty_loyalty_service.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/domain/services/beauty_loyalty_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/reviews/controllers/beauty_review_controller.dart';
import 'package:sixam_mart/features/beauty_module/reviews/domain/repositories/beauty_review_repository.dart';
import 'package:sixam_mart/features/beauty_module/reviews/domain/repositories/beauty_review_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/reviews/domain/services/beauty_review_service.dart';
import 'package:sixam_mart/features/beauty_module/reviews/domain/services/beauty_review_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/consultation/controllers/beauty_consultation_controller.dart';
import 'package:sixam_mart/features/beauty_module/consultation/domain/repositories/beauty_consultation_repository.dart';
import 'package:sixam_mart/features/beauty_module/consultation/domain/repositories/beauty_consultation_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/consultation/domain/services/beauty_consultation_service.dart';
import 'package:sixam_mart/features/beauty_module/consultation/domain/services/beauty_consultation_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/notifications/controllers/beauty_notification_controller.dart';
import 'package:sixam_mart/features/beauty_module/notifications/domain/repositories/beauty_notification_repository.dart';
import 'package:sixam_mart/features/beauty_module/notifications/domain/repositories/beauty_notification_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/notifications/domain/services/beauty_notification_service.dart';
import 'package:sixam_mart/features/beauty_module/notifications/domain/services/beauty_notification_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/controllers/beauty_dashboard_controller.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/domain/repositories/beauty_dashboard_repository.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/domain/repositories/beauty_dashboard_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/domain/services/beauty_dashboard_service.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/domain/services/beauty_dashboard_service_interface.dart';
import 'package:sixam_mart/features/beauty_module/wallet/controllers/beauty_wallet_controller.dart';
import 'package:sixam_mart/features/beauty_module/wallet/domain/repositories/beauty_wallet_repository.dart';
import 'package:sixam_mart/features/beauty_module/wallet/domain/repositories/beauty_wallet_repository_interface.dart';
import 'package:sixam_mart/features/beauty_module/wallet/domain/services/beauty_wallet_service.dart';
import 'package:sixam_mart/features/beauty_module/wallet/domain/services/beauty_wallet_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  BeautyHomeRepositoryInterface beautyHomeRepositoryInterface = BeautyHomeRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => beautyHomeRepositoryInterface);

  BeautySalonRepositoryInterface beautySalonRepositoryInterface = BeautySalonRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => beautySalonRepositoryInterface);

  BeautyBookingRepositoryInterface beautyBookingRepositoryInterface = BeautyBookingRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => beautyBookingRepositoryInterface);

  BeautyRetailRepositoryInterface beautyRetailRepositoryInterface = BeautyRetailRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyRetailRepositoryInterface);

  BeautyPackageRepositoryInterface beautyPackageRepositoryInterface = BeautyPackageRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyPackageRepositoryInterface);

  BeautyGiftCardRepositoryInterface beautyGiftCardRepositoryInterface = BeautyGiftCardRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyGiftCardRepositoryInterface);

  BeautyLoyaltyRepositoryInterface beautyLoyaltyRepositoryInterface = BeautyLoyaltyRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyLoyaltyRepositoryInterface);

  BeautyReviewRepositoryInterface beautyReviewRepositoryInterface = BeautyReviewRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyReviewRepositoryInterface);

  BeautyConsultationRepositoryInterface beautyConsultationRepositoryInterface = BeautyConsultationRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyConsultationRepositoryInterface);

  BeautyNotificationRepositoryInterface beautyNotificationRepositoryInterface = BeautyNotificationRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyNotificationRepositoryInterface);

  BeautyDashboardRepositoryInterface beautyDashboardRepositoryInterface = BeautyDashboardRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyDashboardRepositoryInterface);

  BeautyWalletRepositoryInterface beautyWalletRepositoryInterface = BeautyWalletRepository(apiClient: Get.find());
  Get.lazyPut(() => beautyWalletRepositoryInterface);
  ...
  BeautyHomeServiceInterface beautyHomeServiceInterface = BeautyHomeService(beautyHomeRepositoryInterface: Get.find());
  Get.lazyPut(() => beautyHomeServiceInterface);

  BeautySalonServiceInterface beautySalonServiceInterface = BeautySalonService(beautySalonRepositoryInterface: Get.find());
  Get.lazyPut(() => beautySalonServiceInterface);

  BeautyBookingServiceInterface beautyBookingServiceInterface = BeautyBookingService(beautyBookingRepositoryInterface: Get.find());
  Get.lazyPut(() => beautyBookingServiceInterface);

  BeautyRetailServiceInterface beautyRetailServiceInterface = BeautyRetailService(retailRepository: Get.find());
  Get.lazyPut(() => beautyRetailServiceInterface);

  BeautyPackageServiceInterface beautyPackageServiceInterface = BeautyPackageService(packageRepository: Get.find());
  Get.lazyPut(() => beautyPackageServiceInterface);

  BeautyGiftCardServiceInterface beautyGiftCardServiceInterface = BeautyGiftCardService(giftCardRepository: Get.find());
  Get.lazyPut(() => beautyGiftCardServiceInterface);

  BeautyLoyaltyServiceInterface beautyLoyaltyServiceInterface = BeautyLoyaltyService(loyaltyRepository: Get.find());
  Get.lazyPut(() => beautyLoyaltyServiceInterface);

  BeautyReviewServiceInterface beautyReviewServiceInterface = BeautyReviewService(reviewRepository: Get.find());
  Get.lazyPut(() => beautyReviewServiceInterface);

  BeautyConsultationServiceInterface beautyConsultationServiceInterface = BeautyConsultationService(consultationRepository: Get.find());
  Get.lazyPut(() => beautyConsultationServiceInterface);

  BeautyNotificationServiceInterface beautyNotificationServiceInterface = BeautyNotificationService(notificationRepository: Get.find());
  Get.lazyPut(() => beautyNotificationServiceInterface);

  BeautyDashboardServiceInterface beautyDashboardServiceInterface = BeautyDashboardService(dashboardRepository: Get.find());
  Get.lazyPut(() => beautyDashboardServiceInterface);

  BeautyWalletServiceInterface beautyWalletServiceInterface = BeautyWalletService(walletRepository: Get.find());
  Get.lazyPut(() => beautyWalletServiceInterface);
  ...
  Get.lazyPut(() => BeautyHomeController(beautyHomeServiceInterface: Get.find()));
  Get.lazyPut(() => BeautySalonController(beautySalonServiceInterface: Get.find()));
  Get.lazyPut(() => BeautyBookingController(beautyBookingServiceInterface: Get.find()));
  Get.lazyPut(() => BeautyRetailController(retailService: Get.find()));
  Get.lazyPut(() => BeautyPackageController(packageService: Get.find()));
  Get.lazyPut(() => BeautyGiftCardController(apiClient: Get.find()));
  Get.lazyPut(() => BeautyLoyaltyController(apiClient: Get.find()));
  Get.lazyPut(() => BeautyReviewController(apiClient: Get.find()));
  Get.lazyPut(() => BeautyConsultationController(consultationService: Get.find()));
  Get.lazyPut(() => BeautyNotificationController(notificationService: Get.find()));
  Get.lazyPut(() => BeautyDashboardController(dashboardService: Get.find()));
  Get.lazyPut(() => BeautyWalletController(walletService: Get.find()));
