...
import 'package:sixam_mart/features/beauty_module/home/screens/beauty_home_screen.dart';
import 'package:sixam_mart/features/beauty_module/salon_details/screens/beauty_salon_details_screen.dart';
import 'package:sixam_mart/features/beauty_module/booking/screens/beauty_booking_list_screen.dart';
import 'package:sixam_mart/features/beauty_module/booking/screens/beauty_booking_details_screen.dart';
import 'package:sixam_mart/features/beauty_module/booking/screens/beauty_booking_create_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_cart_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_checkout_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_order_details_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_order_tracking_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_orders_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_products_screen.dart';
import 'package:sixam_mart/features/beauty_module/retail/screens/beauty_retail_product_details_screen.dart';
import 'package:sixam_mart/features/beauty_module/packages/screens/beauty_packages_screen.dart';
import 'package:sixam_mart/features/beauty_module/packages/screens/beauty_package_details_screen.dart';
import 'package:sixam_mart/features/beauty_module/consultations/screens/beauty_consultations_screen.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/screens/beauty_gift_cards_list_screen.dart';
import 'package:sixam_mart/features/beauty_module/gift_cards/screens/beauty_gift_cards_screen.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/screens/beauty_loyalty_screen.dart';
import 'package:sixam_mart/features/beauty_module/loyalty/screens/beauty_loyalty_points_screen.dart';
import 'package:sixam_mart/features/beauty_module/reviews/screens/beauty_review_create_screen.dart';
import 'package:sixam_mart/features/beauty_module/reviews/screens/beauty_reviews_screen.dart';
import 'package:sixam_mart/features/beauty_module/notifications/screens/beauty_notifications_screen.dart';
import 'package:sixam_mart/features/beauty_module/dashboard/screens/beauty_dashboard_screen.dart';
import 'package:sixam_mart/features/beauty_module/wallet/screens/beauty_wallet_screen.dart';
import 'package:sixam_mart/features/beauty_module/booking/screens/beauty_booking_conversation_screen.dart';
import 'package:sixam_mart/features/beauty_module/booking/screens/beauty_waitlist_screen.dart';
...
class RouteHelper {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: BeautyRouteHelper.beautySalons, page: () => const BeautyHomeScreen()),
    GetPage(name: BeautyRouteHelper.beautySalonDetails, page: () => BeautySalonDetailsScreen(salonId: int.parse(Get.parameters['id'] ?? '0'))),
    GetPage(name: BeautyRouteHelper.beautyBookings, page: () => const BeautyBookingListScreen()),
    GetPage(name: BeautyRouteHelper.beautyBookingDetails, page: () => BeautyBookingDetailsScreen(bookingId: int.parse(Get.parameters['id'] ?? '0'))),
    GetPage(name: BeautyRouteHelper.beautyCreateBooking, page: () => BeautyBookingCreateScreen(
      salonId: Get.parameters['salon_id'] != null ? int.tryParse(Get.parameters['salon_id']!) : null,
      serviceId: Get.parameters['service_id'] != null ? int.tryParse(Get.parameters['service_id']!) : null,
    )),
    GetPage(name: BeautyRouteHelper.beautyRetailProducts, page: () => const BeautyRetailProductsScreen()),
    GetPage(name: BeautyRouteHelper.beautyRetailProductDetails, page: () => BeautyRetailProductDetailsScreen(
      productId: int.parse(Get.parameters['id'] ?? '0'),
    )),
    GetPage(name: BeautyRouteHelper.beautyRetailCart, page: () => const BeautyRetailCartScreen()),
    GetPage(name: BeautyRouteHelper.beautyRetailCheckout, page: () => const BeautyRetailCheckoutScreen()),
    GetPage(name: BeautyRouteHelper.beautyRetailOrders, page: () => const BeautyRetailOrdersScreen()),
    GetPage(name: BeautyRouteHelper.beautyRetailOrderDetails, page: () => BeautyRetailOrderDetailsScreen(
      orderId: int.parse(Get.parameters['id'] ?? '0'),
    )),
    GetPage(name: BeautyRouteHelper.beautyRetailOrderTracking, page: () => BeautyRetailOrderTrackingScreen(
      orderId: int.parse(Get.parameters['id'] ?? '0'),
    )),
    GetPage(name: BeautyRouteHelper.beautyPackages, page: () => const BeautyPackagesScreen()),
    GetPage(name: BeautyRouteHelper.beautyPackageDetails, page: () => BeautyPackageDetailsScreen(
      packageId: int.parse(Get.parameters['id'] ?? '0'),
    )),
    GetPage(name: BeautyRouteHelper.beautyConsultations, page: () => const BeautyConsultationsScreen()),
    GetPage(name: BeautyRouteHelper.beautyGiftCards, page: () => const BeautyGiftCardsScreen()),
    GetPage(name: BeautyRouteHelper.beautyGiftCardHistory, page: () => const BeautyGiftCardsListScreen()),
    GetPage(name: BeautyRouteHelper.beautyLoyaltyPoints, page: () => const BeautyLoyaltyPointsScreen()),
    GetPage(name: BeautyRouteHelper.beautySubmitReview, page: () => const BeautyReviewsScreen()),
    GetPage(name: BeautyRouteHelper.beautyReviewCreate, page: () => const BeautyReviewCreateScreen()),
    GetPage(name: BeautyRouteHelper.beautyNotifications, page: () => const BeautyNotificationsScreen()),
    GetPage(name: BeautyRouteHelper.beautyDashboard, page: () => const BeautyDashboardScreen()),
    GetPage(name: BeautyRouteHelper.beautyWallet, page: () => const BeautyWalletScreen()),
    GetPage(
      name: BeautyRouteHelper.beautyBookingConversation,
      page: () => BeautyBookingConversationScreen(bookingId: int.parse(Get.parameters['id'] ?? '0')),
    ),
    GetPage(name: BeautyRouteHelper.beautyWaitlist, page: () => const BeautyWaitlistScreen()),
