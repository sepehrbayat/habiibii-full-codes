...
import StaffList from "../../../../src/components/home/module-wise-components/beauty/vendor/StaffList";
import { getServerSideProps } from "../../../index";

const VendorStaff = ({ configData, landingPageData }) => {
  return (
    <>
      <CssBaseline />
      <SEO
        title={configData ? `Vendor Staff` : "Loading..."}
        image={`${getImageUrl(
