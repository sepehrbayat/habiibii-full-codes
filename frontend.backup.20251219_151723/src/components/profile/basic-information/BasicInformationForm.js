          ...
          <Grid item md={6} xs={12}>
            <Stack position="relative">
              <TextField
                ...
                helperText={safeHelperText(profileFormik.errors.email, profileFormik.touched.email)}
            ...
            <>
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  helperText={safeHelperText(profileFormik.errors.password, profileFormik.touched.password)}
                  InputProps={{
                    endAdornment: (
              ...
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  helperText={safeHelperText(profileFormik.errors.confirm_password, profileFormik.touched.confirm_password)}
