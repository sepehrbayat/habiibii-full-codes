...
import 'package:sixam_mart_store/features/beauty_module/dashboard/screens/vendor_beauty_dashboard_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/screens/vendor_beauty_bookings_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/screens/vendor_beauty_booking_details_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/screens/vendor_beauty_staff_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/services/screens/vendor_beauty_services_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/screens/vendor_beauty_calendar_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/screens/vendor_beauty_badges_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/screens/vendor_beauty_retail_orders_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/screens/vendor_beauty_retail_order_details_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/screens/vendor_beauty_retail_product_form_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/screens/vendor_beauty_retail_products_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/screens/vendor_beauty_finance_summary_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/screens/vendor_beauty_transactions_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/screens/vendor_beauty_subscription_plans_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/screens/vendor_beauty_subscription_status_screen.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/screens/vendor_beauty_subscription_history_screen.dart';
...
class RouteHelper {
  ...
  static const String beautyStaff = '/beauty-staff';
  static const String beautyServices = '/beauty-services';
  static const String beautyCalendar = '/beauty-calendar';
  static const String beautyBadges = '/beauty-badges';
  static const String beautyRetailProducts = '/beauty-retail-products';
  static const String beautyRetailProductForm = '/beauty-retail-product-form';
  ...
  static const String beautyFinanceSummary = '/beauty-finance-summary';
  static const String beautyFinanceTransactions = '/beauty-finance-transactions';
  static const String beautySubscriptionPlans = '/beauty-subscription-plans';
  static const String beautySubscriptionStatus = '/beauty-subscription-status';
  static const String beautySubscriptionHistory = '/beauty-subscription-history';
  ...
  static String getBeautyBookingDetailsRoute(int bookingId) => '$beautyBookingDetails?id=$bookingId';
  static String getBeautyStaffRoute() => beautyStaff;
  static String getBeautyServicesRoute() => beautyServices;
  static String getBeautyCalendarRoute() => beautyCalendar;
  static String getBeautyBadgesRoute() => beautyBadges;
  static String getBeautyRetailProductsRoute() => beautyRetailProducts;
  static String getBeautyRetailProductFormRoute({int? productId}) {
    if (productId != null) {
      return '$beautyRetailProductForm?id=$productId';
    }
    return beautyRetailProductForm;
  }
  static String getBeautyRetailOrdersRoute() => beautyRetailOrders;
  static String getBeautyRetailOrderDetailsRoute(int orderId) => '$beautyRetailOrderDetails?id=$orderId';
  static String getBeautyFinanceSummaryRoute() => beautyFinanceSummary;
  static String getBeautyFinanceTransactionsRoute() => beautyFinanceTransactions;
  static String getBeautySubscriptionPlansRoute() => beautySubscriptionPlans;
  static String getBeautySubscriptionStatusRoute() => beautySubscriptionStatus;
  static String getBeautySubscriptionHistoryRoute() => beautySubscriptionHistory;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: beautyDashboard, page: () => const VendorBeautyDashboardScreen()),
    GetPage(name: beautyBookings, page: () => const VendorBeautyBookingsScreen()),
    GetPage(name: beautyBookingDetails, page: () => VendorBeautyBookingDetailsScreen(bookingId: int.parse(Get.parameters['id']!))),
    GetPage(name: beautyStaff, page: () => const VendorBeautyStaffScreen()),
    GetPage(name: beautyServices, page: () => const VendorBeautyServicesScreen()),
    GetPage(name: beautyCalendar, page: () => const VendorBeautyCalendarScreen()),
    GetPage(name: beautyBadges, page: () => const VendorBeautyBadgesScreen()),
    GetPage(name: beautyRetailProducts, page: () => const VendorBeautyRetailProductsScreen()),
    GetPage(name: beautyRetailProductForm, page: () => VendorBeautyRetailProductFormScreen(
      productId: Get.parameters['id'] != null ? int.tryParse(Get.parameters['id']!) : null,
    )),
    GetPage(name: beautyRetailOrders, page: () => const VendorBeautyRetailOrdersScreen()),
    GetPage(name: beautyRetailOrderDetails, page: () => VendorBeautyRetailOrderDetailsScreen(
      orderId: int.parse(Get.parameters['id'] ?? '0'),
    )),
    GetPage(name: beautyFinanceSummary, page: () => const VendorBeautyFinanceSummaryScreen()),
    GetPage(name: beautyFinanceTransactions, page: () => const VendorBeautyTransactionsScreen()),
    GetPage(name: beautySubscriptionPlans, page: () => const VendorBeautySubscriptionPlansScreen()),
    GetPage(name: beautySubscriptionStatus, page: () => const VendorBeautySubscriptionStatusScreen()),
    GetPage(name: beautySubscriptionHistory, page: () => const VendorBeautySubscriptionHistoryScreen()),
