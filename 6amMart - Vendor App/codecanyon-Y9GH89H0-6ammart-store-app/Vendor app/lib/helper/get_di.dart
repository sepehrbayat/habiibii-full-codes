...
import 'package:sixam_mart_store/features/beauty_module/dashboard/controllers/vendor_beauty_dashboard_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/dashboard/domain/repositories/vendor_beauty_dashboard_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/dashboard/domain/repositories/vendor_beauty_dashboard_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/dashboard/domain/services/vendor_beauty_dashboard_service.dart';
import 'package:sixam_mart_store/features/beauty_module/dashboard/domain/services/vendor_beauty_dashboard_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/controllers/vendor_beauty_booking_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/domain/repositories/vendor_beauty_booking_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/domain/repositories/vendor_beauty_booking_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/domain/services/vendor_beauty_booking_service.dart';
import 'package:sixam_mart_store/features/beauty_module/bookings/domain/services/vendor_beauty_booking_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/controllers/vendor_beauty_staff_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/domain/repositories/vendor_beauty_staff_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/domain/repositories/vendor_beauty_staff_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/domain/services/vendor_beauty_staff_service.dart';
import 'package:sixam_mart_store/features/beauty_module/staff/domain/services/vendor_beauty_staff_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/services/controllers/vendor_beauty_service_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/services/domain/repositories/vendor_beauty_service_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/services/domain/repositories/vendor_beauty_service_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/services/domain/services/vendor_beauty_service_service.dart';
import 'package:sixam_mart_store/features/beauty_module/services/domain/services/vendor_beauty_service_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/controllers/vendor_beauty_calendar_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/domain/repositories/vendor_beauty_calendar_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/domain/repositories/vendor_beauty_calendar_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/domain/services/vendor_beauty_calendar_service.dart';
import 'package:sixam_mart_store/features/beauty_module/calendar/domain/services/vendor_beauty_calendar_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/controllers/vendor_beauty_badge_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/domain/repositories/vendor_beauty_badge_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/domain/repositories/vendor_beauty_badge_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/domain/services/vendor_beauty_badge_service.dart';
import 'package:sixam_mart_store/features/beauty_module/badges/domain/services/vendor_beauty_badge_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/controllers/vendor_beauty_retail_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/domain/repositories/vendor_beauty_retail_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/domain/repositories/vendor_beauty_retail_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/domain/services/vendor_beauty_retail_service.dart';
import 'package:sixam_mart_store/features/beauty_module/retail/domain/services/vendor_beauty_retail_service_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/controllers/vendor_beauty_finance_controller.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/domain/repositories/vendor_beauty_finance_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/domain/repositories/vendor_beauty_finance_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/domain/services/vendor_beauty_finance_service.dart';
import 'package:sixam_mart_store/features/beauty_module/finance/domain/services/vendor_beauty_finance_service_interface.dart';
...
import 'package:sixam_mart_store/features/beauty_module/subscription/domain/repositories/vendor_beauty_subscription_repository.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/domain/repositories/vendor_beauty_subscription_repository_interface.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/domain/services/vendor_beauty_subscription_service.dart';
import 'package:sixam_mart_store/features/beauty_module/subscription/domain/services/vendor_beauty_subscription_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  VendorBeautyDashboardRepositoryInterface vendorBeautyDashboardRepositoryInterface = VendorBeautyDashboardRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyDashboardRepositoryInterface);

  VendorBeautyBookingRepositoryInterface vendorBeautyBookingRepositoryInterface = VendorBeautyBookingRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyBookingRepositoryInterface);

  VendorBeautyStaffRepositoryInterface vendorBeautyStaffRepositoryInterface = VendorBeautyStaffRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyStaffRepositoryInterface);

  VendorBeautyServiceRepositoryInterface vendorBeautyServiceRepositoryInterface = VendorBeautyServiceRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyServiceRepositoryInterface);

  VendorBeautyCalendarRepositoryInterface vendorBeautyCalendarRepositoryInterface = VendorBeautyCalendarRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyCalendarRepositoryInterface);

  VendorBeautyBadgeRepositoryInterface vendorBeautyBadgeRepositoryInterface = VendorBeautyBadgeRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyBadgeRepositoryInterface);

  VendorBeautyRetailRepositoryInterface vendorBeautyRetailRepositoryInterface = VendorBeautyRetailRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyRetailRepositoryInterface);

  VendorBeautyFinanceRepositoryInterface vendorBeautyFinanceRepositoryInterface = VendorBeautyFinanceRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautyFinanceRepositoryInterface);

  VendorBeautySubscriptionRepositoryInterface vendorBeautySubscriptionRepositoryInterface = VendorBeautySubscriptionRepository(apiClient: Get.find());
  Get.lazyPut(() => vendorBeautySubscriptionRepositoryInterface);
  ...
  VendorBeautyDashboardServiceInterface vendorBeautyDashboardServiceInterface = VendorBeautyDashboardService(dashboardRepository: Get.find());
  Get.lazyPut(() => vendorBeautyDashboardServiceInterface);

  VendorBeautyBookingServiceInterface vendorBeautyBookingServiceInterface = VendorBeautyBookingService(bookingRepository: Get.find());
  Get.lazyPut(() => vendorBeautyBookingServiceInterface);

  VendorBeautyStaffServiceInterface vendorBeautyStaffServiceInterface = VendorBeautyStaffService(staffRepository: Get.find());
  Get.lazyPut(() => vendorBeautyStaffServiceInterface);

  VendorBeautyServiceServiceInterface vendorBeautyServiceServiceInterface = VendorBeautyServiceService(serviceRepository: Get.find());
  Get.lazyPut(() => vendorBeautyServiceServiceInterface);

  VendorBeautyCalendarServiceInterface vendorBeautyCalendarServiceInterface = VendorBeautyCalendarService(calendarRepository: Get.find());
  Get.lazyPut(() => vendorBeautyCalendarServiceInterface);

  VendorBeautyBadgeServiceInterface vendorBeautyBadgeServiceInterface = VendorBeautyBadgeService(badgeRepository: Get.find());
  Get.lazyPut(() => vendorBeautyBadgeServiceInterface);

  VendorBeautyRetailServiceInterface vendorBeautyRetailServiceInterface = VendorBeautyRetailService(retailRepository: Get.find());
  Get.lazyPut(() => vendorBeautyRetailServiceInterface);

  VendorBeautyFinanceServiceInterface vendorBeautyFinanceServiceInterface = VendorBeautyFinanceService(financeRepository: Get.find());
  Get.lazyPut(() => vendorBeautyFinanceServiceInterface);

  VendorBeautySubscriptionServiceInterface vendorBeautySubscriptionServiceInterface = VendorBeautySubscriptionService(subscriptionRepository: Get.find());
  Get.lazyPut(() => vendorBeautySubscriptionServiceInterface);
  ...
  Get.lazyPut(() => VendorBeautyDashboardController(dashboardService: Get.find()));
  Get.lazyPut(() => VendorBeautyBookingController(bookingService: Get.find()));
  Get.lazyPut(() => VendorBeautyStaffController(staffService: Get.find()));
  Get.lazyPut(() => VendorBeautyServiceController(serviceService: Get.find()));
  Get.lazyPut(() => VendorBeautyCalendarController(calendarService: Get.find()));
  Get.lazyPut(() => VendorBeautyBadgeController(badgeService: Get.find()));
  Get.lazyPut(() => VendorBeautyRetailController(retailService: Get.find()));
  Get.lazyPut(() => VendorBeautyFinanceController(financeService: Get.find()));
  Get.lazyPut(() => VendorBeautySubscriptionController(subscriptionService: Get.find()));
