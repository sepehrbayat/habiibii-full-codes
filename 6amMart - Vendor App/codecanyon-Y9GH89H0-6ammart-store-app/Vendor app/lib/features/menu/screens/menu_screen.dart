...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(store?.module?.moduleType == 'beauty' || store?.module?.moduleType == 'beautybooking') {
      menuList.add(MenuModel(icon: Images.bannerIcon, title: 'beauty_dashboard'.tr, route: RouteHelper.getBeautyDashboardRoute()));
      menuList.add(MenuModel(icon: Images.order, title: 'beauty_bookings'.tr, route: RouteHelper.getBeautyBookingsRoute()));
      menuList.add(MenuModel(icon: Images.deliveryMan, iconColor: Colors.white, title: 'beauty_staff'.tr, route: RouteHelper.getBeautyStaffRoute()));
      menuList.add(MenuModel(icon: Images.categories, title: 'beauty_services'.tr, route: RouteHelper.getBeautyServicesRoute()));
      menuList.add(MenuModel(icon: Images.announcementIcon, title: 'beauty_calendar'.tr, route: RouteHelper.getBeautyCalendarRoute()));
      menuList.add(MenuModel(icon: Images.bannerIcon, title: 'beauty_badges'.tr, route: RouteHelper.getBeautyBadgesRoute()));
      menuList.add(MenuModel(icon: Images.addFood, title: 'beauty_retail_products'.tr, route: RouteHelper.getBeautyRetailProductsRoute()));
      menuList.add(MenuModel(icon: Images.order, title: 'beauty_retail_orders'.tr, route: RouteHelper.getBeautyRetailOrdersRoute()));
      menuList.add(MenuModel(icon: Images.walletSelect, title: 'beauty_finance'.tr, route: RouteHelper.getBeautyFinanceSummaryRoute()));
      menuList.add(MenuModel(icon: Images.mySubscriptionIcon, title: 'beauty_subscription'.tr, route: RouteHelper.getBeautySubscriptionStatusRoute()));
    }
